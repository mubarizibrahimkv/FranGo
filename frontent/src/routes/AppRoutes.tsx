...
const AdminPendingApproval = lazy(() => import("../pages/Admin/AdminPendingApprovals"));
const AdminCompanyDetails = lazy(() => import("../pages/Admin/CompanyDetails"));
const AdminInvestorDetails = lazy(() => import("../pages/Admin/InvestorDetails"));
const CompanyFranchises=lazy(()=>import("../pages/Company/companyFranchises"));
const AdminIndustryCategory=lazy(()=>import("../pages/Admin/AdminCategory"));
const CompanyFranchiseDetails=lazy(()=>import("../pages/Company/companyFranchiseDetails"));
const ExploreFranchises=lazy(()=>import("../pages/Investor/ExploreFranchise"));
...
const InvestorApplication=lazy(()=>import("../pages/Investor/MyApplication"))
const CompanyProductCategory=lazy(()=>import("../pages/Company/CompanyProductCategory"))
            ...
            <Suspense fallback={
                ...
                <Routes>
                    ...
                    <Route element={<ProtectedRoute allowedRoles={["company"]} />}>
                        ...
                        <Route path="/company/franchise/:id" element={<CompanyFranchiseDetails />} />
                        <Route path="/company/profile" element={<CompnayProfile />} />
                        <Route path="/company/application" element={<CompanyApplications />} />
                        <Route path="/company/category" element={<CompanyProductCategory />} />
                    ...
                    <Route element={<ProtectedRoute allowedRoles={["customer"]} />}>
                        ...
                        <Route path="/admin/company/:id" element={<AdminCompanyDetails />} />
                        <Route path="/admin/investors" element={<AdminInvestor />} />
                        <Route path="/admin/investor/:id" element={<AdminInvestorDetails />} />
                        <Route path="/admin/customers" element={<AdminCustomer />} />
                        <Route path="/admin/industry-category" element={<AdminIndustryCategory />} />
                        <Route path="/admin/pendingApproval/:role" element={<AdminPendingApproval />} />
