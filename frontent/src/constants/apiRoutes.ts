...
export const INVESTOR_PROFILE_ROUTES = {
    ...
    UPDATE_PROFILE: (id: string) =>
        `/${INVESTOR_BASE_ROUTE}/${id}/updateProfile`,
    UPDATE_PROFILE_IMAGE: (id: string) =>
        `/${INVESTOR_BASE_ROUTE}/${id}/profile`,
    REAPPLY: (id: string) =>
        `/${INVESTOR_BASE_ROUTE}/profile/reapply/${id}`,
};
...
export const NOTIFICATION_ROUTES = {
    GET_ALL: (role: string, userId: string) =>
...
export const CUSTOMER_PROFILE = {
    ADD_ADDRESS: (customerId: string) => `/${CUSTOMER_BASE_ROUTE}/profile/address/${customerId}`,
    EDIT_ADDRESS: (addressId: string) => `/${CUSTOMER_BASE_ROUTE}/profile/address/${addressId}`,
    DELETE_ADDRESS: (addressId: string) => `/${CUSTOMER_BASE_ROUTE}/profile/address/${addressId}`,
    GET_ADDRESS: (customerId: string) => `/${CUSTOMER_BASE_ROUTE}/profile/address/${customerId}`,
    GET_CUSTOMER: (customerId: string) =>  `/${CUSTOMER_BASE_ROUTE}/profile/${customerId}`,
};
...
export const ADMIN_API = {
  ...
  COMPANY_DETAILS: (id: string) =>
    `/${ADMIN_BASE_ROUTE}/company/${id}`,

  INVESTOR_DETAILS: (id: string) =>
    `/${ADMIN_BASE_ROUTE}/investor/${id}`,
