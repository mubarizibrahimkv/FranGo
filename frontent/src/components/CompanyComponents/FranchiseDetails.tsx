  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            {franchise.advancefee || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Royalty Fee:</span>{" "}
            {franchise.royaltyfee || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Advertisement Fee:</span>{" "}
            {franchise.advertisingfee || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Total Investment:</span>{" "}
            {franchise.totalInvestement || "N/A"}
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <span className="font-semibold">Minimum Space:</span>{" "}
            {franchise.minimumSpace || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Preferred Type Property:</span>{" "}
            {franchise.preferedProperty || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Preferred Location:</span>{" "}
            {franchise.preferedLocation?.join(",") || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Accessibility:</span>{" "}
            {franchise.accessibility || "N/A"}
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <span className="font-semibold">Franchise Outlet Format:</span>{" "}
            {franchise.outletFormat || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Ownership Model:</span>{" "}
            {franchise.ownershipModel || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Support Provided:</span>{" "}
            {franchise.supportProvided || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Training Type:</span>{" "}
            {franchise.trainingType || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Employees Required:</span>{" "}
            {franchise.staffRequired || "N/A"}
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <span className="font-semibold">Agreement Duration:</span>{" "}
            {franchise.agreementDuration || "N/A"}
          </div>
          <div>
            <span className="font-semibold">Renewal Duration:</span>{" "}
            {franchise.renewelDuration || "N/A"}
          </div>
        </div>
      </div>
