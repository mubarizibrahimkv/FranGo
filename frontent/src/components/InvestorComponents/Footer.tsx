...
const Footer = () => {
  return (
    <footer className="bg-[#071621] text-white py-10 px-6 font-sans">
      ...
      <div className="border-t border-gray-600 mt-10 pt-4 text-center text-sm text-orange-500">
        © {new Date().getFullYear()} FranGo. All rights reserved.
      </div>
    </footer>
  );
};
