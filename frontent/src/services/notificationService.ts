...
export const updateNotification = async (role: IRole, notificationId: string) => {
    console.log(role,notificationId,"roel and notificaiton id respectively in seriver")
    try {
