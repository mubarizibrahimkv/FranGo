...
export interface IAdminInvestorRepo {
    getPendingInvestors(limit:number,skip:number,search:string): Promise<IInvestor[]> | null
    getApprovedInvestors(limit:number,skip:number,search:string): Promise<IInvestor[]|null> 
