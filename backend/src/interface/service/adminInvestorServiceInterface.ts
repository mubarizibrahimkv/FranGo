...
export interface IAdminInvestorService{
    getPendingInvestors(page:number):Promise<{investor: IInvestor[],totalPages: number}>
    getApprovedInvestors(page:number): Promise<{investor: IInvestor[],totalPages: number}>;
